...
<?php } ?>
        ...
        $("#project-table").appTable({
            ...
            columns: [
                ...
                {visible: optionVisibility, title: '<?php echo app_lang("title") ?>'}
                <?php echo $custom_field_headers; ?>,
                {title: '<?php echo app_lang("client") ?>', "class": "w10p"},
                // {visible: optionVisibility, title: '<?php echo app_lang("price") ?>', "class": "w10p"},
                {visible: false},
                {visible: optionVisibility, title: '<?php echo app_lang("start_date") ?>', "class": "w10p", "iDataSort": 4},
                {visible: false, searchable: false},
                {visible: optionVisibility, title: '<?php echo app_lang("deadline") ?>', "class": "w10p", "iDataSort": 6},
